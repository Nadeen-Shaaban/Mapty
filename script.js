...
class App {
    #map;
    #mapZoomLevel = 13;
    #mapEvent; //both saro private instance property
    #workouts = [];
    ...
    navigator.geolocation.getCurrentPosition(this._loadMap.bind(this), //krml tbttl t3tina undefined l this
    function(){
        ...
        e.preventDefault();
            ...
            if(type === 'running') {
                ...
                !validInputs(distance, duration, cadence) || !allPositives(distance, duration, cadence)
                   ...
                   return alert('Inputs have to be positive nmbers!');
    ...
    _renderWorkoutMaker(workout) {
        L.marker(workout.coords) //create the marker
            ...
            .setPopupContent(`${workout.type === 'running' ?  '🏃‍♂️' : '🚴‍♀️'} ${workout.description}`) //sho ykn mktoub 3l popup
            .openPopup();
    }
